        ...
        <div class="g-mn1c">
            <div class="user-con">
                ...
                <h1>下载记录</h1>
                    ...
                    <table class="layui-table" lay-data="{width: 892, height:480, url:'<%=request.getContextPath()%>/download/record.do?userId=${user.userId}', page:false, id:'idTest'}" lay-filter="demo">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                            <th lay-data="{field:'paperId', width:80, sort: true, fixed: true}">试卷ID</th>
                            <th lay-data="{field:'paperName', width:300}">试卷名称</th>
                            <th lay-data="{field:'downDate', width:280, sort: true}">下载时间</th>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    //删除记录========================================================
                    $.ajax({
                        url: server_context + '/download/delete.do',
                        type: 'POST', //GET

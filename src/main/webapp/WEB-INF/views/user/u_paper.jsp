            ...
            <div class="user-con">
                ...
                <h1>试卷收藏</h1>
                    ...
                    <div class="layui-btn-group demoTable">
                        <button class="layui-btn" data-type="getCheckData">批量取消收藏</button>
                    </div>

                    <table class="layui-table"
                           lay-data="{width: 892, height:600, url:'<%=request.getContextPath()%>/paperfav/record.do?userId=${user.userId}', page:false, id:'idTest'}"
                           lay-filter="demo">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                            <th lay-data="{field:'paperGradeName', width:70, sort: true, fixed: true}">年级</th>
                            <th lay-data="{field:'paperCourseName', width:65, sort: true, fixed: true}">学科</th>
                            <th lay-data="{field:'paperName', width:209, sort: true, fixed: true}">试卷名称</th>
                            <th lay-data="{field:'score', sort: true, width:65}">总分</th>
                            <th lay-data="{field:'total', sort: true, width:81}">总题数</th>
                            <th lay-data="{field:'paperDifficultyDesc', sort: true, width:102}">试卷难度</th>
                            <th lay-data="{field:'time', sort: true, width:150}">考试时长(分钟)</th>
                    ...
                    <script type="text/html" id="barDemo">
                        ...
                        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="del">取消收藏</a>
                    </script>
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    //删除记录========================================================
                    $.ajax({
                        url: server_context + '/paperfav/delete.do',
                        type: 'POST', //GET

        ...
        <div class="user-msg">
            ...
            <div class="user-using">
                <ul>
                    ...
                    <c:if test="${loginUser.userType=='1'}"><li><a href="<%=request.getContextPath()%>/ucenter/question_in_record.do" id="question_in_record"><i class="icona-dtk"></i></i>试题录入记录</a></li></c:if>

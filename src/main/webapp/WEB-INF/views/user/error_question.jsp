        ...
        <div class="g-mn1c">
            <div class="user-con">
                ...
                <h1>错题本</h1>
                    ...
                    <table class="layui-table" lay-data="{width: 892, height:600, url:'<%=request.getContextPath()%>/error_book/record.do?userId=${user.userId}', page:false, id:'idTest'}" lay-filter="demo">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                            <th lay-data="{field:'gradeName', width:64, sort: true, fixed: true}">年级</th>
                            <th lay-data="{field:'courseName', width:65, sort: true, fixed: true}">学科</th>
                            <th lay-data="{field:'questionClass1', width:93, sort: true, fixed: true}">试题类别</th>
                            <th lay-data="{field:'questionType1', width:75}">题型</th>
                            <th lay-data="{field:'questionContent', width:250}">题干</th>
                            <th lay-data="{field:'myAnswer', width:150}">我的回答</th>
                            <th lay-data="{field:'createDate', width:158, sort: true}">加入时间</th>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    //删除记录========================================================
                    $.ajax({
                        url: server_context + '/error_book/delete.do',
                        type: 'POST', //GET

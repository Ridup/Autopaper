            ...
            <div class="user-con">
                ...
                <h1>测试记录</h1>
                    ...
                    <table class="layui-table"
                           lay-data="{width: 892, height:600, url:'<%=request.getContextPath()%>/paper/test_record.do?userId=${user.userId}', page:false, id:'idTest'}"
                           lay-filter="demo">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                            <th lay-data="{field:'paperName', width:293, sort: true, fixed: true}">试卷名称</th>
                            <th lay-data="{field:'testScore', width:65, sort: true, fixed: true}">得分</th>
                            <th lay-data="{field:'costTime', width:135, sort: true, fixed: true}">花费时间(分钟)</th>
                            <th lay-data="{field:'startTimeStr', width:165}">开始时间</th>
                    ...
                    <script type="text/html" id="barDemo" style="width: 247px">
                        ...
                        <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="testpaper">重新测试</a>
...
<script type="text/javascript">
    ...
    layui.use('table', function () {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                //查看===========================================================
                window.location.href = server_context + "/paper/test_report.do?testId=" + data.testId;
            }

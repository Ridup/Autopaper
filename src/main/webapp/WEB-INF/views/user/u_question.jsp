        ...
        <div class="g-mn1c">
            <div class="user-con">
                ...
                <h1>试题收藏</h1>
                    ...
                    <table class="layui-table" lay-data="{width: 892, height:480, url:'<%=request.getContextPath()%>/questionfav/record.do?userId=${user.userId}', page:false, id:'idTest'}" lay-filter="demo">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
                            <th lay-data="{field:'gradeName', width:80, sort: true, fixed: true}">年级</th>
                            <th lay-data="{field:'courseName', width:80,sort: true, fixed: true}"></th>学科
                            <th lay-data="{field:'questionContent', width:280, sort: true}">题干</th>
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    //删除记录========================================================
                    $.ajax({
                        url: server_context + '/questionfav/delete.do',
                        type: 'POST', //GET

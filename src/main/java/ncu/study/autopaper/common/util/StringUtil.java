 ...
 * 
 * @author Ridup
 * @version $Id: StringUtil.java, v 0.1 Oct 13, 2015 6:29:23 PM Ridup Exp $
 */
public class StringUtil {
     ...
     * @param start 开始下标
     * @param end 结束下标
     * @return String 隐藏后字符串
     * @throws
     */
    public static String hideString(String srcStr, int start, int end){
        return StringUtil.hideString(srcStr, start-1, end, '*');
    }
     ...
     * @param start 开始下标
     * @param end 结束下标
     * @param replacechar 隐藏字符（如：*）
     * @return String 隐藏后字符串
     * @throws
     */
    public static String hideString(String srcStr, int start, int end, char replacechar){
        if(srcStr != null && !srcStr.equals("")){
            StringBuffer hideStr = new StringBuffer(srcStr.length());
            
            hideStr.append(rightPad(srcStr.substring(0, start),end,String.valueOf(replacechar)))
            .append(srcStr.substring(end));
    ...
    /**
     * 去除字符串空格，若为null，返回空字符串
     * @Title: clean
     * @param aStr 字符串
     * @return String 去除空格后字符串
     * @throws
     */
    public static String clean(String aStr) {
     ...
     * @return 分割后的字符串数组，如果原字符串为<code>null</code>，则返回<code>null</code>
     */
    public static String[] splitWithNull(String str, String separatorChars) {
        return splitWithNull(str, separatorChars, -1);
    }
     ...
     * @return 分割后的字符串数组，如果原字符串为<code>null</code>，则返回<code>null</code>
     */
    public static String[] splitWithNull(String str, String separatorChars, int max) {
        if (str == null) {
            return null;
        }
     ...
     * @return
     */
    public String getSubString(String srcStr,int start ,int end){
        if(srcStr!=null){
